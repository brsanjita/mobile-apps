...
class _CountrySelectionScreenState extends State<CountrySelectionScreen> {
  ...
  Widget buildCountriesList() {
    if (this.countries == null) return Center(child:CircularProgressIndicator());
    print("Search $search");
    List<Country>countries=this.countries.where((country)=>country.countryName.toLowerCase().startsWith(search.toLowerCase())).toList();
